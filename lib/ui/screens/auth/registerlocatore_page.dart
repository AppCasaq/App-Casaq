...
class RegisterLocatorePage extends StatefulWidget {
  const RegisterLocatorePage({super.key});

  @override
  State<RegisterLocatorePage> createState() => _RegisterLocatorePageState();
}

class _RegisterLocatorePageState extends State<RegisterLocatorePage> {
...
@override
  ...
  Widget _buildRoleDropdown() {
    return DropdownButtonFormField<String>(
      value: _selectedRole,
      items: const ['Locatore', 'Proprietario', 'Agenzia']
          .map((e) => DropdownMenuItem(value: e, child: Text(e)))
          .toList(),
      onChanged: (value) => setState(() => _selectedRole = value),
      decoration: _inputDecoration("Tipologia"),
      validator: (value) =>
          value == null ? 'Seleziona il tipo utente' : null,
    );
  }
}